...
public class Constants_Old {
    ...
    /**
     * Needs to be called once at the beginning. (After config initialization)
     */
    ...
    public static Map<String, String> DOCKER_IDENTIFIER_TAG = new HashMap<String, String>() {{ put("Owner", "DockerMC"); }};
