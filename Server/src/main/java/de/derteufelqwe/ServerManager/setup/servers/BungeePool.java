...
public class BungeePool extends ServerTemplate {
    ...
    public BungeePool(String image, String ramLimit, String cpuLimit, String name, int replications, Map<String, List<String>> constraints) {
        super(image, ramLimit, cpuLimit, name, replications, constraints);
    }

    //    public BungeePool(Docker docker) {
//        super(docker);
//    }
    ...
    protected List<PortConfig> getPortConfigs() {
