...
Set-MrInternetConnectionSharing -InternetInterfaceName 'WLAN' -LocalInterfaceName 'vEthernet (Snitch)' -Enabled $false
Set-MrInternetConnectionSharing -InternetInterfaceName 'WLAN' -LocalInterfaceName 'vEthernet (Snitch)' -Enabled $true